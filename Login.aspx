    ...
    <form id="form1" runat="server">
        ...
        <div class="logo-section">
            ...
            <div class="remember-forgot">
                ...
                <asp:HyperLink ID="lnkForgot" runat="server" NavigateUrl="~/ForgotPassword.aspx">Quên mật khẩu?</asp:HyperLink>
            </div>

            <asp:Button ID="btnLogin" runat="server" Text="Đăng nhập" CssClass="btn-login" OnClick="btnLogin_Click" />

        <div class="signup-link">
            Chưa có tài khoản? <asp:HyperLink ID="lnkSignup" runat="server" NavigateUrl="~/signup.aspx">Đăng ký ngay</asp:HyperLink>
        </div>
    </div>
